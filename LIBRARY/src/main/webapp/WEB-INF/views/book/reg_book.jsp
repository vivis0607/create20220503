		...
		<div style="background-color: #eeeeee; padding: 16px; border-radius: 12px;">
			<form class="row g-3" action="/book/regBook" method="post" id="regBookForm" enctype="multipart/form-data">
				...
				<div class="col-12">
					...
					<input type="number" min="10" max="500" value="200" class="form-control" id="bkPage" name="bkPage">
				</div>
				<div class="col-12">
					<label for="bkSize" class="form-label">크기</label>
					<input type="number" min="100" max="300" value="200" class="form-control" id="bkSize" name="bkSize">cm
				</div>
				<div class="col-12">
