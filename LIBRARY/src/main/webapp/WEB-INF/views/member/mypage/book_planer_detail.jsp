...
<button onclick="bookPlanerDelete(${bookPlaner.complitCode});">삭제</button>
<button>수정</button>
<button onclick="location.href='/book/bookDetail?bookCode=${bookPlaner.bookCode}'">해당 도서 상세보기</button>
